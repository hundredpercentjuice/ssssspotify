...
class HTMXalbumListView(generic.ListView):
    model = models.album
...
class HTMXalbumCreateView(generic.CreateView):
    model = models.album
    form_class = forms.albumForm
...
class HTMXalbumDeleteView(generic.DeleteView):
    model = models.album
    success_url = reverse_lazy("album_tracker_album_htmx_list")
